...
export async function create(ctx: RoleTxContext, data: CreateTaskPriorityInput) {
  try {
...
export async function update(ctx: RoleTxContext, id: string, data: UpdateTaskPriorityInput) {
